...
<table>
  ...
  <tr>
    <td width="33%"><img src="<?php echo $row["image"]; ?>" class="img-responsive" name ="image" height="200px" width="200px" /></td>
    <td width="33%"><h4 class="text" name="price">$ <?php echo $row["price"]; ?></h4></td>
	...
	<input type="submit" name="add_to_cart" style="margin-top:5px;"  value="Add to Cart" style="background-color: #555555 "/></td>
			...
			<br />
			<h3>Order Details</h3>
			<form action="onlineshopping_process.php" method ="post" >
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					?>
					<tr>
						<td name="itemname"><?php echo $values["item_name"]; ?></td>
						<td name="quantity"><?php echo $values["item_quantity"]; ?></td>
						<td name="price">$ <?php echo $values["item_price"]; ?></td>
